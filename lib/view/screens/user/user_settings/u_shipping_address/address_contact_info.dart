...
class AddressContactInfo extends StatefulWidget {
  @override
  State<AddressContactInfo> createState() => _AddressContactInfoState();
}

class _AddressContactInfoState extends State<AddressContactInfo> {
  @override
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          MyText(
            text:
                "Enter contact details for this shipping address, including phone and email.",
            size: 16,
            lineHeight: 1.5,
