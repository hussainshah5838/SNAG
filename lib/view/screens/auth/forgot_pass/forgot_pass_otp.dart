    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const Align(alignment: Alignment.bottomCenter, child: _OTPBottomSheet()),
        ],
      ),
    );
  }
...
class _OTPBottomSheetState extends State<_OTPBottomSheet> {
  ...
  void onVerify() {
    ...
    // Navigate to create new password with the code
    Get.to(() => CreateNewPass(code: pinController.text));
  }

  Future<void> onResend() async {
    await _auth.forgotPassword(email: _auth.pendingEmail.value);
  ...
  Widget build(BuildContext context) {
    final PinTheme pinTheme = PinTheme(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          width: 1.0,
          color: pinStatus == 'invalid' ? const Color(0xFFF73434) : kBorderColor,
        ),
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          MyText(
            text: 'Enter the 5-digit code we sent to your email.',
            size: 16,
            lineHeight: 1.5,
