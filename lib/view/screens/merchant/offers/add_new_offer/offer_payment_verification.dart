...
import 'package:snag/view/screens/merchant/offers/add_new_offer/offer_payment_successfull.dart';
...
class OfferPaymentVerification extends StatefulWidget {
  @override
  State<OfferPaymentVerification> createState() =>
      _OfferPaymentVerificationState();
}

class _OfferPaymentVerificationState extends State<OfferPaymentVerification> {
  String pinStatus = '';
